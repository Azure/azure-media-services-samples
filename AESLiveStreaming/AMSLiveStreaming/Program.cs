...
namespace AMSLiveStreaming
{
    class Program
    {
        ...
        private const string AssetlName = "asset1";
        private const string ProgramlName = "program1";
        ...
        public static IProgram CreateAndStartProgram(IChannel channel)
        {
            ...
            IProgram program = channel.Programs.Create(ProgramlName, TimeSpan.FromMinutes(5), asset.Id);
            program.Start();
